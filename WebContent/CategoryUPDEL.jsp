	...
	<form action="./Category">
		<center>
								...
								<A class="catg" href="CategoryUPDEL.jsp">UpdateCategory<A>
										<A class="catg" href="addproduct.jsp">Add<A> <A
												class="catg" href="modifyproduct.jsp">Modify<A> <A
														class="catg" href="deleteproduct.jsp">Delete<A> <!--<A class="catg" href="films.jsp">Films</A>-->
			...
			<table>
				...
				<tr>
					<th>CategoryName</th>
					<td><input type="text" name="upcategory"></td>
				</tr>
				...
				<tr>
					<th colspan=2><input type="submit" name="add" value="Update">
