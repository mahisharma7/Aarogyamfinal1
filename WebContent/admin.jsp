...
<body><jsp:include page="admin_transactions.jsp" /><BR>
	<TABLE Color=black cellSpacing=3 cellPadding=3 width=500 align=left
		border=0>
		<TBODY>
			<TR>
				<TD noWrap align=left>Ayurvedic</TD>
				<TD noWrap align=left>Ayurveda is an ancient Indian system of
					medicine</TD>
			</TR>
			<TR>
			...
			<TR>
				...
				<TD noWrap align=left>Eye Care products for beautiful and
					glowing eyes</TD>
			</TR>
			<TR>
				<TD noWrap align=left>Hair&Skin Care</TD>
				<TD noWrap align=left>Professional hair and skin care products
					available</TD>
			</TR>
			<TR>
				<TD noWrap align=left>Health Care</TD>
				<TD noWrap align=left>All kinds of medicine for your health
					care</TD>
			</TR>
			<TR>
				<TD noWrap align=left>Nutrition</TD>
				<TD noWrap align=left>safe and nutritious food supply for ur
					good health</TD>
			</TR>
			<TR>
				<TD noWrap align=left>Over the Counter(OTC)</TD>
				<TD noWrap align=left>You can buy without a prescription from a
