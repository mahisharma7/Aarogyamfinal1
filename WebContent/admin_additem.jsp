...
<%
  ...
  if(eff>0) out.println("<link rel=stylesheet href='./CSS/cyber.css'><body bgcolor=gray><center><h1><font face=tahoma color=ivory>Item Added to Inventory Successfully .<BR><BR></h1><br><br><center><a href=\"javascript:history.back()\">Continue</a>&nbsp;&nbsp;<a href=\"javascript:parent.close()\">Skip From This Page</a>");
    ...
    else out.println("<link rel=stylesheet href='user.css'><body bgcolor=gray><center><h1><font face=tahoma color=ivory>Transaction Failed While Adding Ur Item to Inventory.Due To Error:<BR>"+e+"</h1><br><br><center><a href=\"javascript:history.back()\">Continue</a>&nbsp;&nbsp;<a href=\"javascript:parent.close()\">Skip From This Page</a>");
  }
  %>
<html xmlns=""><head>
